...
class _ArgParser:
	...
	sync_options.add_argument("-g", "--global-renames", action=BOA, default=None, help="Enable/disable renaming files between directories.")
	sync_options.add_argument("-c", "--content-match", action=BOA, default=None, help="Enable/disable reading the last 1kb of files when finding renamed files in 'dst'. If false, the backup process will rely solely on file metadata.")
	...
	sync_options.add_argument("-L", "--err-limit", metavar="LIMIT", type=int, default=None, help="Quit after this many filesystem errors.")
