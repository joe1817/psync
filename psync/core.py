...
class Filter:
	...
	@classmethod
	def _convert_to_glob_string(cls, pattern, *, is_glob:bool, glob_is_escaped:bool):
		glob_string = ""
		escape = False
		for c in pattern:
			if c == "\\":
	...
	@classmethod
	def _parse_pattern(cls, action, pattern, *, ignore_hidden:bool, ignore_case:bool, is_glob:bool, glob_is_escaped:bool):
		sep = f"{os.sep}/"
	...
	def allow(self, *patterns, ignore_hidden:bool|None = None, ignore_case:bool|None = None, is_glob:bool|None = None, glob_is_escaped:bool|None = None) -> "Filter":
		for pattern in patterns:
			filter = Filter._parse_pattern(True, pattern,
				...
				glob_is_escaped = glob_is_escaped,
			)
			if filter:
	...
	def __init__(self, filter_string:str = None, *, ignore_hidden:bool = False, ignore_case:bool = False, is_glob:bool = True, glob_is_escaped:bool = False, default:bool = False):
